...
void setup() {
  size (1920, 1000); // Optimized for 1080p; change to fullScreen() if preferred
  smooth();
...
void drawObject() {
  ...
  // Updated scaling: 0.0025 adjusts the pixels to fit 400cm into the radar arcs
  pixsDistance = iDistance*((height-height*0.1666)*0.0025); 
  
  // Updated range limit to 400cm
  if(iDistance < 400){
...
void drawText() { 
  ...
  // Updated Labels for 400cm scale
